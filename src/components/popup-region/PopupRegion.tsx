...
// 					Math.min(prev + 1, targetRegion.length - 1),
// 				);
// 			}
// 		},
// 		onSwipedRight: () => {
// 			if (isMobile) {
// 				setActiveChartIndex(prev => Math.max(prev - 1, 0));
// 			}
// 		},
// 	});

// 	const data = isMobile ? targetRegion[activeChartIndex] || [] : targetRegion;
...
// 			{isMobile ? (
// 				<>
// 					{/* {activeChartIndex === 0 && <ColumnChart data={targetRegion[0]} />}
// 					{activeChartIndex === 1 && <ColumnChart data={targetRegion[1]} />} */}
// 					{targetRegion[activeChartIndex] && (
// 						<ColumnChart data={targetRegion[activeChartIndex]} />
// 					)}
